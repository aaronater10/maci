...
# 1. TOML Load String - Loading toml string data and test attributes
def test1_tomlloadstr_data():
    filename = '1_load_data_file.toml'
    filepath = test_file_path + filename    

    # Test Data and it's Type
    toml_raw = maci.loadraw(filepath)
    toml_import = maci.tomlloadstr(toml_raw)
