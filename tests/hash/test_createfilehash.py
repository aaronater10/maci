...
SHA256_BIN = "76be8b528d0075f7aae98d6fa57a6d3c83ae480a8469e668d7b0af968995ac71"
...
def test3_createfilehash_encodings():
    file_to_hash = '3_file_hash_encoding.data'
    filepath_to_hash = test_file_path + file_to_hash
...
# 4. Binary File - Test hash of binary file
def test4_createfilehash_binary_file():
    file_to_hash = '4_file_hash_binary'
    filepath_to_hash = test_file_path + file_to_hash

    # Using default hash algorithm SHA256
    assert SHA256_BIN == maci.createfilehash(filepath_to_hash, None)
